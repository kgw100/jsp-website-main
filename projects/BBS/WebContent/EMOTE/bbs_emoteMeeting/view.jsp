				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><%=bbs.getBbsUserID()%></td>
										...
										<tr>
						<td>회의 참가자</td>
						<td colspan="2"><%=bbs.getParticipant()%></td>
					</tr>
					<tr>
						<td>회의 내용</td>
					...
					<tr>
						<td>회의 결과</td>
						<!-- replaceAll해주는 이유 :cross site scripting해킹에 대한 방지  -->
						<td colspan="2" style="min-height: 150px; text-align: left;"><%=bbs.getResult().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
					.replaceAll("\n", "<br>")%></td>
					</tr>
					<td>특이 사항</td>
					<!-- replaceAll해주는 이유 :cross site scripting해킹에 대한 방지  -->
					<td colspan="2" style="min-height: 150px; text-align: left;"><%=bbs.getSpecialNote().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
					.replaceAll("\n", "<br>")%></td>
					</tr>
