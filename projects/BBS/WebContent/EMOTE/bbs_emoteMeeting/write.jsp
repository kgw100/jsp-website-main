					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control"
								placeholder="회의 제목" name="bbsTitle" maslength="50"></td>
						</tr>
						<tr>
							<td><input type="text" class="form-control"
								placeholder="회의 참가자" name="participant" maslength="128"></td>
						</tr>
						<tr>
						...
						<tr>
							<td><textarea class="form-control" placeholder="회의 결과"
									name="result" maxlength="3000" style="height: 300px;"></textarea></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="특이 사항"
									name="specialNote" maxlength="3000" style="height: 250px;"></textarea></td>
						</tr>
					</tbody>
				</table>
