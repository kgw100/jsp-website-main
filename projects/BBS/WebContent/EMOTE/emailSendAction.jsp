...
if(emailChecked == true) {
	...
	session.invalidate(); // 세션뺐기 => 세션을 뺐지 않으면 사용자의 아이디만 알아내도 로그인이 가능해지는 취약점 발생 
...
// 사용자에게 보낼 메시지를 기입합니다.
String host = "http://www.emocert.com:8080/EMOTE/";
String from = "emocert@emocert.com";
String to = user.getUserEmail();
int i = (int)Math.floor(Math.random() * 1000000) + 1;
String key = Integer.toString(i);
String subject = "[EMOTE 가입 이메일 인증]";// 이모트와 와이서트 에 따라 변경할 것 
  ...
  <body>
    <section>
      ...
      <div class="tbl-content">
            <br>
          <div>&#62; 인증 메일이 전송되었습니다. <br>  회원 가입시 기입한 메일로 인증을 시도해주십시오.</div>
      </div>
    </section>
