...
<%@ page import="emoteCommunity2.EmoteCommunity2"%>
<%@ page import="emoteCommunity2.EmoteCommunity2DAO"%>
<%--게시판 목록출력위함 --%>
...
></a>
	...
	<div class="background">
		<img src="../image/커뮤니티2_emote.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteCommunity2DAO bbsDAO = new EmoteCommunity2DAO();
						ArrayList<EmoteCommunity2> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteCommunity2/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteCommunity2.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteCommunity2/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
