...
<%@ page import="emoteDevelopmentField1.EmoteDevelopmentField1"%>
<%@ page import="emoteDevelopmentField1.EmoteDevelopmentField1DAO"%>
<%--게시판 목록출력위함 --%>
...
></a>
	...
	<div class="background">
		<img src="../image/개발1_emote.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<thead>
					<tr>
						...
						<th style="background-color: #eeeeee; text-align: center;">회의 주제</th>
						<th style="background-color: #eeeeee; text-align: center;">작성일</th>
					</tr>
				</thead>
				<tbody>
					<%
					EmoteDevelopmentField1DAO bbsDAO = new EmoteDevelopmentField1DAO();
						ArrayList<EmoteDevelopmentField1> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteDevelopmentField1/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteDevelopmentField1.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteDevelopmentField1/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
	...
	<div class="logo_and_tel">
		...
		<div class="bottom_tel">
			강원도 원주시 연세대길1 창조관 164호<br /> TEL. 010-6554-3886
		</div>
	</div>
	<%--애니메이션 담당--%>
