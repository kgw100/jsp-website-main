...
<%@ page import="emoteDevelopmentField2.EmoteDevelopmentField2"%>
<%@ page import="emoteDevelopmentField2.EmoteDevelopmentField2DAO"%>
<%--게시판 목록출력위함 --%>
...
></a>
			...
			<div class="main_menu">
				<div class="menubar">
					<ul>
						...
						<li><a href="#">커뮤니티</a>
							<ul>
								<li><a onclick="location='emoteMain.jsp#div1';" style="cursor: pointer;">소개</a></li>
								<li><a href="emoteCommunity1.jsp">졸업생 게시판</a></li>
								<li><a href="emoteCommunity2.jsp">재학생 게시판</a></li>
							</ul></li>
						<li><a href="emoteMeeting.jsp">회의록</a>
	...
	<div class="background">
		<img src="../image/개발2_emote.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteDevelopmentField2/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteDevelopmentField2.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteDevelopmentField2/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
