...
<%@ page import="emoteDevelopmentField4.EmoteDevelopmentField4"%>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteDevelopmentField4DAO bbsDAO = new EmoteDevelopmentField4DAO();
						ArrayList<EmoteDevelopmentField4> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteDevelopmentField4/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteDevelopmentField4.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteDevelopmentField4/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
