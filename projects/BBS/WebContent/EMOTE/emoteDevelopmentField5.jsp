...
></a>
	...
	<div class="background">
		<img src="../image/개발5_emote.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteDevelopmentField5/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteDevelopmentField5.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteDevelopmentField5/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
