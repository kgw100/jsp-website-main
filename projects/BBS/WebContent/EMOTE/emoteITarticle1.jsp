...
<%@ page import="emoteITarticle1.EmoteITarticle1DAO"%>
<%@ page import="emoteITarticle1.EmoteITarticle1"%>
<%--게시판 목록출력위함 --%>
...
<div class="head2">
	...
	<div class="background">
		<img src="../image/IT소식1_emote.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteITarticle1DAO bbsDAO = new EmoteITarticle1DAO();
						ArrayList<EmoteITarticle1> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteITarticle1/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteITarticle1.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteITarticle1/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
