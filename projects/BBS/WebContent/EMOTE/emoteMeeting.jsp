...
<!-- <style>
.background {
  background-image: url("../image/회의_emote.png");
...
></a>
	...
	<div class="background">
		<img src="../image/회의록_emote.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteMeetingDAO bbsDAO = new EmoteMeetingDAO();
						ArrayList<EmoteMeeting> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteMeeting/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteMeeting.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteMeeting/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
