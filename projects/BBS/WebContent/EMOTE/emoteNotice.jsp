...
<!-- <style>
.background {
  background-image: url("../image/공지_emote.png");
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteNoticeDAO bbsDAO = new EmoteNoticeDAO();
						ArrayList<EmoteNotice> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_emoteNotice/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="emoteNotice.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_emoteNotice/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
