		...
		<table align="center" cellpadding="8" cellspacing="4">
			...
			<tr>
				...
				<td><input class="info_blank" type="password"
					name="userPassword"  minlength="6" maxlength="16" placeholder="Password(최소 6글자)"></td>
			</tr>
			<tr>
				<td class="font_style" align="right">REPASSWORD:</td>
				<td><input class="info_blank" type="password"
					name="reUserPassword"  minlength="6" maxlength="16" placeholder="Password(최소 6글자)"></td>
			</tr>
			<tr>
...
<!-- 				<td><input id="confirm" type="submit" name="confirm"
					value="CONFIRM" style="cursor: pointer; text-decoration: none;"
					href="javascript:alert('비밀번호 찾기에 쓰입니다.');">CONFIRM</a></td> -->
			</tr>
