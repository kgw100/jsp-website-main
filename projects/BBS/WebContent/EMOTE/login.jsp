...
<body bgcolor="black" link="#41f200" vlink="#41f200" alink="#FFFFFF">
    ...
    <br><br><br><br><br>
      ...
      <!--비밀번호찾기, 회원가입, 비회원접속-->
      <table align="center" cellpadding="8"><tr>
          <td><a class="below_bar" style="text-decoration:none;" href="javascript:alert('기능 점검중입니다. 관리자에게 문의하세요.');">비밀번호 찾기</td>
          <td><a class="below_bar" style="text-decoration:none;" href="join.jsp">회원가입</td>
          <td><a class="below_bar" style="text-decoration:none;" href="e_main.jsp">비회원 접속</td>
      </tr></table>
	<%--애니메이션 담당--%>
