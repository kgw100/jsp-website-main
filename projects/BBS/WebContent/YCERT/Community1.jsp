...
<%@ page import="ycertCommunity1.EmoteCommunity1DAO"%>
<%@ page import="ycertCommunity1.EmoteCommunity1"%>
<%--게시판 목록출력위함 --%>
...
<ul></ul></li>
	...
	<div class="background">
		<img src="../image/커뮤니티1_ycert.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_Community1/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="Community1.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_Community1/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
	...
	<div class="logo_and_tel">
		<div class="bottom_logo">
			<img class="bottom_logo_img" src="../image/ycertLogo_gray.png" alt="ycertLoge_gray">
		</div>
