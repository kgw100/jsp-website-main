...
<%@ page import="ycertDevelopmentField3.EmoteDevelopmentField3"%>
<%@ page import="ycertDevelopmentField3.EmoteDevelopmentField3DAO"%>
<%--게시판 목록출력위함 --%>
...
<ul></ul></li>
	...
	<div class="background">
		<img src="../image/개발3_ycert.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteDevelopmentField3DAO bbsDAO = new EmoteDevelopmentField3DAO();
						ArrayList<EmoteDevelopmentField3> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_DevelopmentField3/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="DevelopmentField3.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_DevelopmentField3/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
