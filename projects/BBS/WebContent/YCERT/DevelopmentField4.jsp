...
<%@ page import="ycertDevelopmentField4.EmoteDevelopmentField4"%>
<%@ page import="ycertDevelopmentField4.EmoteDevelopmentField4DAO"%>
<%--게시판 목록출력위함 --%>
...
<ul></ul></li>
	...
	<div class="background">
		<img src="../image/개발4_ycert.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_DevelopmentField4/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="DevelopmentField4.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_DevelopmentField4/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
