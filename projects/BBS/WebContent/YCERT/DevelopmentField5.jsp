...
<%@ page import="ycertDevelopmentField5.EmoteDevelopmentField5"%>
<%@ page import="ycertDevelopmentField5.EmoteDevelopmentField5DAO"%>
<%--게시판 목록출력위함 --%>
...
<ul></ul></li>
	...
	<div class="background">
		<img src="../image/개발5_ycert.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
					EmoteDevelopmentField5DAO bbsDAO = new EmoteDevelopmentField5DAO();
						ArrayList<EmoteDevelopmentField5> list = bbsDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_DevelopmentField5/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="DevelopmentField5.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_DevelopmentField5/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
