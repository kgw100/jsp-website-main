...
<%@ page import="ycertITarticle1.EmoteITarticle1DAO"%>
<%@ page import="ycertITarticle1.EmoteITarticle1"%>
<%--게시판 목록출력위함 --%>
...
<ul></ul></li>
	...
	<div class="background">
		<img src="../image/IT소식1_ycert.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<tr>
						...
						<td><div class="bbs"><a href="./bbs_ITarticle1/view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			%>
			<a href="ITarticle1.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="bbs_ITarticle1/write.jsp" class="btn btn-success pull-right">글쓰기</a>
		</div>
	</div>
